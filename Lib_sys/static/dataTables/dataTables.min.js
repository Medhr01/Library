...
! function(n) {
    ...
    function _e(t) {
        ...
        if (t.nTableWrapper = r[0], t.sDom)
            for (var o, i, l, s, u, c, d = t, e = t.sDom, f = r, h = e.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++) o = null, "<" == (i = h[p]) ? (l = B("<div/>"), "'" != (s = h[p + 1])[0] && '"' != s[0] || (s = s.replace(/['"]/g, ""), u = "", -1 != s.indexOf(".") ? (c = s.split("."), u = c[0], c = c[1]) : "#" == s[0] ? u = s : c = s, l.attr("id", u.substring(1)).addClass(c), p++), f.append(l), f = l) : ">" == i ? f = f.parent() : "t" == i ? o = He(d) : $.ext.feature.forEach(function(e) {
    ...
    function Ue(e) {
        ...
        if (e.oFeatures.bSort)
            for (Array.isArray(d) && qe(e, h, d), f && d.pre && qe(e, h, d.pre), qe(e, h, e.aaSorting), f && d.post && qe(e, h, d.post), t = 0; t < h.length; t++)
                if (c[l = h[t][0]])
    ...
    U = function(e, t) {
        ...
        iterator: function(e, t, n, a) {
            ...
            for ("string" == typeof e && (a = n, n = t, t = e, e = !1), o = 0, i = h.length; o < i; o++) {
                ...
                if ("table" === t) void 0 !== (r = n.call(g, h[o], o)) && f.push(r);
                    ...
                    for (c = this[o], "column-rows" === t && (u = dt(h[o], p.opts)), l = 0, s = c.length; l < s; l++) d = c[l], void 0 !== (r = "cell" === t ? n.call(g, h[o], d.row, d.column, o, l) : n.call(g, h[o], d, o, l, u)) && f.push(r)
            }
        ...
        unshift: n.unshift
    }), q.__apiStruct = tt, U.extend = function(e, t, n) {
